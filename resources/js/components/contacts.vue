  ...
  <div class="contacts-page">
    ...
    <div class="contacts-container">
      ...
      <div class="table-container">
        ...
        <b-table class="table-curve table" striped hover :items="paginatedContacts" :fields="fields"/>
        <div class="button-container">
          <b-button class="previous-button" @click="previousPage" :disabled="currentPage === 1">Previous</b-button>
          <b-button class="next-button" @click="nextPage" :disabled="currentPage === totalPages">Next</b-button>
        </div>
      </div>
    </div>
  </div>
